...
export class SearchComponent implements OnInit {
  ...
  ngOnInit() {
    const scopes = 'user-read-private user-read-email user-read-birthdate playlist-modify-public' +
    ' playlist-modify-private user-read-playback-state';
    this.signinref = 'https://accounts.spotify.com/authorize?response_type=code&client_id=a4053a069ef047e2a10c49745a218670&scope='
